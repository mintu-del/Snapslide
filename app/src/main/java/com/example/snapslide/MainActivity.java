...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load(R.drawable.baselayout).into(base);
        Glide.with(this).load(R.drawable.image_element1).into(element1);
        Glide.with(this).load(R.drawable.image_element2).into(element2);
